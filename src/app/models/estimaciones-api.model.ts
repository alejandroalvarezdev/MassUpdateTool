import { ObjConId } from "./obj-con-id.model";
        ...
        export interface EstimacionesAPI {
                ...
                life_insurance_amount?: number;  // Asumimos que "Moneda" es un valor numérico representando la cantidad en dinero;                // Moneda
                ...
                previous_contracts?: ObjConId;  // Buscar (asumido como string)                  // Decimal
                previous_sale_price?: number;  // Decimal                  // Número
                vacation_credits?: number;  // Número                  // Decimal
                annual_fee?: number;  // Decimal                  // Porcentaje
                idp_percentage?: number;  // Porcentaje                  // Moneda
                minimum_down_payment_amount?: number;  // Moneda                  // Moneda
                ...
                Fecha_del_Primer_Uso?: Date;  // Fecha                  // Fecha
                ...
                deal?: ObjConId;  // Buscar (asumido como string)                  // Buscar
                ...
                tablet_type?: ObjConId;  // Buscar (asumido como string)                  // Buscar
